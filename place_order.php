...
* this file contains methods for placing the orders which can be done through product_info.php
* multiple checks required: ordering too many, ordering too few, ordering at the same time as someone else
...
<div class="container">
    ...
    if(isset($_COOKIE[$cookie_name])) {
        ...
        if($prod_stock < $quan) {
            ...
            //create new order
            $query = "INSERT INTO orders (userID, productID, quantity, totalPrice, datePlaced, dateDispatched) VALUES ('$user_id', '$prod_id', '$quan', '$total', '".date("Y,m,d H:i:s", time())."', 'NULL');";
