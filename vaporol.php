  ...
  <div class="main">
    ...
    <div class="container grid-custom">
      <div class="customPadding">
        <div class="row">
          <div class="col-md-12">
            <h2>VCI Inhibitors: VPI and VCI</h2>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <p class="text-justify">
              Vaporol is nitrite free and does not contain any volatile solvents or other volatile organic compounds (VOCs) damaging to the environment. No chlorinated substances or heavy metals are present.
            </p>
            <h3>COMPATIBILITY WITH FUELS &amp; OILS</h3>
            <p class="text-justify">
              ...
              <br>
              <br> Some synthetic oils, especially those based on polyglycols, may not be compatible – if any doubt exists, please consult us as we can usually formulate special products to meet specific requirements.
            </p>
            <h3>AQUAVAP</h3>
            <p class="text-justify">
