...
* this file will contain information relating to the cablegard line of products
* eventually when a full product list is added to the site several of these will be linked from this page.
        ...
        <div class="customPadding">
            ...
            <div class="row">
                <div class="col-md-6">
                    <h2>THE SOLUTION</h2>
                    <p class="text-justify">
                        Most overhead power cables/conductors Cablegard is the easily applied anticorrosive that reaches where others cannot and performs where others fail. By this means it extends conductor life, thereby offering the world’s power generators and distributors major cost savings.
                    </p>
                    <h3>COLD APPLIED</h3>
                    <p class="text-justify">
                    ...
                    <h3>FILLS THE CONDUCTOR COMPLETELY</h3>
                    <p class="text-justify">
                    ...
                    <h3>WILL NOT MELT OR DRAIN AWAY</h3>
                    <p class="text-justify">
                ...
                <div class="col-md-6">
                    <h3> </h3>
                    <img src="res/cablegard-3.jpg" alt="Rust" class="img-responsive center-block">
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="text-justify">
                        ...
                        <br>
                        <br>
                        <span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Ease of application
                        <br>
                        <span class="glyphicon glyphicon-ok" aria-hidden="true"></span> No trace-heated pipework to install and maintain
                        <br>
                        <span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Elimination of heating and capital costs associated with storing and pumping molten grease
                        <br>
                        <span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Improved safety compared to the handling of hot molten grease.
                        <br>
                        <span class="glyphicon glyphicon-ok" aria-hidden="true"></span> Cleaner, less messy operation
                    </p>
                    <h3>LONG TERM – “THE BOTTOM LINE”</h3>
                    <p>
                        ...
                        <br>
                        <br>
                        <i class="cablegard">&pound;</i> The cost of pylons
                        <br>
                        <i class="cablegard">&pound;</i> The cost of conductors themselves
                        <br>
                        <i class="cablegard">&pound;</i> Greatest cost of all…replacement of corroded conductors
                        <br>
                        <i class="cablegard">&pound;</i> Manufacturing costs
                        <br>
                        <i class="cablegard">&pound;</i> Conductor erection
                    </p>
                    <p>
                        For further information, please contact Mr Colin Jones at Vapor-Tek Limited. Telephone +44 (0)1204 521 795.
                        <br>
                        <br> Please request a brochure/technical details by using our on-line enquiry form
                    </p>
                </div>
            </div>
        </div>
